...
import '../repository/add_program_repository.dart';
...
// сохраняет программу в бд, в методе реализована проверка по имени на уже существующую запись
  bool saveProgWithCheckDoubleName(nameOfProgram, programs) {
    ...
    if (_doubleName == false) {
      addProgramRepository
          .save(nameOfProgram); // databaseService.addProgram(nameOfProgram);
    }
    return _doubleName;
  }
